...
<%
	...
	String page_input = "회원가입";
	String page_confirm = "아이디 중복확인";
	String page_login = "로 그 인";
	String page_logout="로 그 아 웃";
	String page_delete = "회 원 탈 퇴";
	String page_modify = "회 원 정 보 수 정";
	
	String msg_main = "회원이 아니시면회원가입을 해주세요";
	String msg_input = "회원정보를 입력해 주세요";
